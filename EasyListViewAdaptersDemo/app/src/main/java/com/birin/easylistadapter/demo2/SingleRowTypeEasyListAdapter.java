...
public class SingleRowTypeEasyListAdapter extends BaseEmployeeEasyListAdapter {

	public SingleRowTypeEasyListAdapter(Context context) {
		super(context);
	}

	@Override
	protected ListRowViewSetter<?, ?>[] getListRowViewSetters() {
		ListRowViewSetter<?, ?>[] rows = { new ProjectManagerListRowViewSetter(
				getContext()) };
		return rows;
	}
