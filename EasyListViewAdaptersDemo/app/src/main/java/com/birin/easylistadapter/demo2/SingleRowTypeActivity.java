...
import com.birin.easylistadapter.base.BaseEmployeeListActivity;

public class SingleRowTypeActivity extends BaseEmployeeListActivity {

	@Override
	protected BaseEmployeeEasyListAdapter getListViewAdapter() {
		return new SingleRowTypeEasyListAdapter(getApplicationContext());
	}

	@Override
	protected BaseDataListRetainingFragment getDataListRetainingFragment() {
		return new SingleRowTypeDataListRetainingFragment();
	}
