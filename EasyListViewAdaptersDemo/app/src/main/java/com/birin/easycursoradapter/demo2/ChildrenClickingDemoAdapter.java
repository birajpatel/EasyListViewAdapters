...
public class ChildrenClickingDemoAdapter extends BaseEmployeeEasyCursorAdapter {

	public ChildrenClickingDemoAdapter(Context context, Cursor c) {
		super(context, c);
	}
	...
	protected CursorRowViewSetter<?>[] getCursorRowViewSetters() {
		...
		CursorRowViewSetter<?>[] rows = {
				new ChildrenClickingProjectManagerRow(context),
				new ChildrenClickingRegularEmployeeRow(context) };
		return rows;
	}
