...
public class TwoRowTypesActivity extends BaseEmployeeListActivity {

	@Override
	protected BaseEmployeeEasyListAdapter getListViewAdapter() {
		return new TwoRowTypesEasyListAdapter(getApplicationContext());
	}

	@Override
	protected BaseDataListRetainingFragment getDataListRetainingFragment() {
		return new TwoRowTypesDataListRetainingFragment();
	}
