...
public abstract class BaseDataListRetainingFragment extends Fragment {

	private DummyDataGeneratorCallback mCallbacks;
	private DummyTask mTask;
	protected ArrayList<Employee> listData = new ArrayList<Employee>();
	...
	protected abstract ArrayList<Employee> generateNewDummyDataAndAddToList();
