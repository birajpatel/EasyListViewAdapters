 ...
 * 1) Recycling views and holders 2) browsing data through data-structure 3)
...
abstract class EasyBaseAdapter<E, T extends BaseRowViewSetter<E, Object>>
    ...
    /**
     * Validate user provided RowViewSetter array length and not null value.
     *
    ...
    /**
     * Check and dispatch load more event, checks if its last position and also if
    ...
    /**
     * Dispatch child click event by finding its data from structure and passing
     ...
     * since only children should be able to traverse the data-structure and
     * return POJO/Cursor.
     *
     * @param position
     *            the position
     ...
     * this method and return correct rowType whose RowViewSetter was registered
     * with this adapter.
     *
     * @param rowData
