 ...
 * click events. This is achieved by tagging views with its click event-id and its
 * current row position, when click event occurs this row position data and event
 * id is retrieved from view tag and passed to client in callback.
 * Whenever getView method is called ,a view holder is returned and
...
public final class ChildViewsClickHandler {
     ...
     *
     * @param childView    the child view (present within RowView) which needs to receive
     *                     click event.
     * @param clickEventId the integer identifier for this childView's click event, this
     *                     Id should be a greater than 0
     */
